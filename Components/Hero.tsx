...
//   return (
//     <div className="h-[100vh] bg-[url('/images/nn.png')] bg-cover bg-center mt-19">
//       <Particle />
...
//           <video 
//             controls // Show native controls for the video player
//             className="max-w-full max-h-full"
//             src="/images/TIM  Exploring Video - Made with Clipchamp.mp4" // Replace with the actual path to your video file
//             type="video/mp4" // Specify the type of the video file
//           />
//           <button 
